...
type ProcessorCoreUnion struct {
	...
	//	*ProcessorCoreUnion_Noop
	//	*ProcessorCoreUnion_TableReader
	//	*ProcessorCoreUnion_JoinReader
	//	*ProcessorCoreUnion_Sorter
	//	*ProcessorCoreUnion_Aggregator
	//	*ProcessorCoreUnion_Distinct
	//	*ProcessorCoreUnion_MergeJoiner
	//	*ProcessorCoreUnion_HashJoiner
	//	*ProcessorCoreUnion_Values
	//	*ProcessorCoreUnion_Backfiller
	//	*ProcessorCoreUnion_SetOp
	Value isProcessorCoreUnion_Value `protobuf_oneof:"value"`
}
...
type isProcessorCoreUnion_Value interface {
	isProcessorCoreUnion_Value()
	MarshalTo([]byte) (int, error)
	Size() int
}

type ProcessorCoreUnion_Noop struct {
	Noop *NoopCoreSpec `protobuf:"bytes,1,opt,name=noop,oneof"`
}
type ProcessorCoreUnion_TableReader struct {
	TableReader *TableReaderSpec `protobuf:"bytes,2,opt,name=tableReader,oneof"`
}
type ProcessorCoreUnion_JoinReader struct {
	JoinReader *JoinReaderSpec `protobuf:"bytes,3,opt,name=joinReader,oneof"`
}
type ProcessorCoreUnion_Sorter struct {
	Sorter *SorterSpec `protobuf:"bytes,4,opt,name=sorter,oneof"`
}
type ProcessorCoreUnion_Aggregator struct {
	Aggregator *AggregatorSpec `protobuf:"bytes,5,opt,name=aggregator,oneof"`
}
type ProcessorCoreUnion_Distinct struct {
	Distinct *DistinctSpec `protobuf:"bytes,7,opt,name=distinct,oneof"`
}
type ProcessorCoreUnion_MergeJoiner struct {
	MergeJoiner *MergeJoinerSpec `protobuf:"bytes,8,opt,name=mergeJoiner,oneof"`
}
type ProcessorCoreUnion_HashJoiner struct {
	HashJoiner *HashJoinerSpec `protobuf:"bytes,9,opt,name=hashJoiner,oneof"`
}
type ProcessorCoreUnion_Values struct {
	Values *ValuesCoreSpec `protobuf:"bytes,10,opt,name=values,oneof"`
}
type ProcessorCoreUnion_Backfiller struct {
	Backfiller *BackfillerSpec `protobuf:"bytes,11,opt,name=backfiller,oneof"`
}
type ProcessorCoreUnion_SetOp struct {
	SetOp *AlgebraicSetOpSpec `protobuf:"bytes,12,opt,name=setOp,oneof"`
}

func (*ProcessorCoreUnion_Noop) isProcessorCoreUnion_Value()        {}
func (*ProcessorCoreUnion_TableReader) isProcessorCoreUnion_Value() {}
func (*ProcessorCoreUnion_JoinReader) isProcessorCoreUnion_Value()  {}
func (*ProcessorCoreUnion_Sorter) isProcessorCoreUnion_Value()      {}
func (*ProcessorCoreUnion_Aggregator) isProcessorCoreUnion_Value()  {}
func (*ProcessorCoreUnion_Distinct) isProcessorCoreUnion_Value()    {}
func (*ProcessorCoreUnion_MergeJoiner) isProcessorCoreUnion_Value() {}
func (*ProcessorCoreUnion_HashJoiner) isProcessorCoreUnion_Value()  {}
func (*ProcessorCoreUnion_Values) isProcessorCoreUnion_Value()      {}
func (*ProcessorCoreUnion_Backfiller) isProcessorCoreUnion_Value()  {}
func (*ProcessorCoreUnion_SetOp) isProcessorCoreUnion_Value()       {}

func (m *ProcessorCoreUnion) GetValue() isProcessorCoreUnion_Value {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *ProcessorCoreUnion) GetNoop() *NoopCoreSpec {
	if x, ok := m.GetValue().(*ProcessorCoreUnion_Noop); ok {
		return x.Noop
	}
	return nil
}

func (m *ProcessorCoreUnion) GetTableReader() *TableReaderSpec {
	if x, ok := m.GetValue().(*ProcessorCoreUnion_TableReader); ok {
		return x.TableReader
	}
	return nil
}

func (m *ProcessorCoreUnion) GetJoinReader() *JoinReaderSpec {
	if x, ok := m.GetValue().(*ProcessorCoreUnion_JoinReader); ok {
		return x.JoinReader
	}
	return nil
}

func (m *ProcessorCoreUnion) GetSorter() *SorterSpec {
	if x, ok := m.GetValue().(*ProcessorCoreUnion_Sorter); ok {
		return x.Sorter
	}
	return nil
}

func (m *ProcessorCoreUnion) GetAggregator() *AggregatorSpec {
	if x, ok := m.GetValue().(*ProcessorCoreUnion_Aggregator); ok {
		return x.Aggregator
	}
	return nil
}

func (m *ProcessorCoreUnion) GetDistinct() *DistinctSpec {
	if x, ok := m.GetValue().(*ProcessorCoreUnion_Distinct); ok {
		return x.Distinct
	}
	return nil
}

func (m *ProcessorCoreUnion) GetMergeJoiner() *MergeJoinerSpec {
	if x, ok := m.GetValue().(*ProcessorCoreUnion_MergeJoiner); ok {
		return x.MergeJoiner
	}
	return nil
}

func (m *ProcessorCoreUnion) GetHashJoiner() *HashJoinerSpec {
	if x, ok := m.GetValue().(*ProcessorCoreUnion_HashJoiner); ok {
		return x.HashJoiner
	}
	return nil
}

func (m *ProcessorCoreUnion) GetValues() *ValuesCoreSpec {
	if x, ok := m.GetValue().(*ProcessorCoreUnion_Values); ok {
		return x.Values
	}
	return nil
}

func (m *ProcessorCoreUnion) GetBackfiller() *BackfillerSpec {
	if x, ok := m.GetValue().(*ProcessorCoreUnion_Backfiller); ok {
		return x.Backfiller
	}
	return nil
}

func (m *ProcessorCoreUnion) GetSetOp() *AlgebraicSetOpSpec {
	if x, ok := m.GetValue().(*ProcessorCoreUnion_SetOp); ok {
		return x.SetOp
	}
	return nil
}
...
func (*ProcessorCoreUnion) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ProcessorCoreUnion_OneofMarshaler, _ProcessorCoreUnion_OneofUnmarshaler, _ProcessorCoreUnion_OneofSizer, []interface{}{
		(*ProcessorCoreUnion_Noop)(nil),
		(*ProcessorCoreUnion_TableReader)(nil),
		(*ProcessorCoreUnion_JoinReader)(nil),
		(*ProcessorCoreUnion_Sorter)(nil),
		(*ProcessorCoreUnion_Aggregator)(nil),
		(*ProcessorCoreUnion_Distinct)(nil),
		(*ProcessorCoreUnion_MergeJoiner)(nil),
		(*ProcessorCoreUnion_HashJoiner)(nil),
		(*ProcessorCoreUnion_Values)(nil),
		(*ProcessorCoreUnion_Backfiller)(nil),
		(*ProcessorCoreUnion_SetOp)(nil),
	}
}

func _ProcessorCoreUnion_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*ProcessorCoreUnion)
	// value
	switch x := m.Value.(type) {
	case *ProcessorCoreUnion_Noop:
		_ = b.EncodeVarint(1<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Noop); err != nil {
			return err
		}
	case *ProcessorCoreUnion_TableReader:
		_ = b.EncodeVarint(2<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.TableReader); err != nil {
			return err
		}
	case *ProcessorCoreUnion_JoinReader:
		_ = b.EncodeVarint(3<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.JoinReader); err != nil {
			return err
		}
	case *ProcessorCoreUnion_Sorter:
		_ = b.EncodeVarint(4<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Sorter); err != nil {
			return err
		}
	case *ProcessorCoreUnion_Aggregator:
		_ = b.EncodeVarint(5<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Aggregator); err != nil {
			return err
		}
	case *ProcessorCoreUnion_Distinct:
		_ = b.EncodeVarint(7<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Distinct); err != nil {
			return err
		}
	case *ProcessorCoreUnion_MergeJoiner:
		_ = b.EncodeVarint(8<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.MergeJoiner); err != nil {
			return err
		}
	case *ProcessorCoreUnion_HashJoiner:
		_ = b.EncodeVarint(9<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.HashJoiner); err != nil {
			return err
		}
	case *ProcessorCoreUnion_Values:
		_ = b.EncodeVarint(10<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Values); err != nil {
			return err
		}
	case *ProcessorCoreUnion_Backfiller:
		_ = b.EncodeVarint(11<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Backfiller); err != nil {
			return err
		}
	case *ProcessorCoreUnion_SetOp:
		_ = b.EncodeVarint(12<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.SetOp); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("ProcessorCoreUnion.Value has unexpected type %T", x)
	}
	return nil
}

func _ProcessorCoreUnion_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*ProcessorCoreUnion)
	switch tag {
	case 1: // value.noop
		...
		msg := new(NoopCoreSpec)
		err := b.DecodeMessage(msg)
		m.Value = &ProcessorCoreUnion_Noop{msg}
		return true, err
	case 2: // value.tableReader
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(TableReaderSpec)
		err := b.DecodeMessage(msg)
		m.Value = &ProcessorCoreUnion_TableReader{msg}
		return true, err
	case 3: // value.joinReader
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(JoinReaderSpec)
		err := b.DecodeMessage(msg)
		m.Value = &ProcessorCoreUnion_JoinReader{msg}
		return true, err
	case 4: // value.sorter
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		...
		msg := new(SorterSpec)
		err := b.DecodeMessage(msg)
		m.Value = &ProcessorCoreUnion_Sorter{msg}
		return true, err
	case 5: // value.aggregator
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(AggregatorSpec)
		err := b.DecodeMessage(msg)
		m.Value = &ProcessorCoreUnion_Aggregator{msg}
		return true, err
	case 7: // value.distinct
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(DistinctSpec)
		err := b.DecodeMessage(msg)
		m.Value = &ProcessorCoreUnion_Distinct{msg}
		return true, err
	case 8: // value.mergeJoiner
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(MergeJoinerSpec)
		err := b.DecodeMessage(msg)
		m.Value = &ProcessorCoreUnion_MergeJoiner{msg}
		return true, err
	case 9: // value.hashJoiner
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(HashJoinerSpec)
		err := b.DecodeMessage(msg)
		m.Value = &ProcessorCoreUnion_HashJoiner{msg}
		return true, err
	case 10: // value.values
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ValuesCoreSpec)
		err := b.DecodeMessage(msg)
		m.Value = &ProcessorCoreUnion_Values{msg}
		return true, err
	case 11: // value.backfiller
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(BackfillerSpec)
		err := b.DecodeMessage(msg)
		m.Value = &ProcessorCoreUnion_Backfiller{msg}
		return true, err
	case 12: // value.setOp
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(AlgebraicSetOpSpec)
		err := b.DecodeMessage(msg)
		m.Value = &ProcessorCoreUnion_SetOp{msg}
		return true, err
	default:
		return false, nil
	}
...
func _ProcessorCoreUnion_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*ProcessorCoreUnion)
	// value
	switch x := m.Value.(type) {
	case *ProcessorCoreUnion_Noop:
		...
		n += s
	case *ProcessorCoreUnion_TableReader:
		s := proto.Size(x.TableReader)
		n += proto.SizeVarint(2<<3 | proto.WireBytes)
		n += proto.SizeVarint(uint64(s))
		n += s
	case *ProcessorCoreUnion_JoinReader:
		s := proto.Size(x.JoinReader)
		n += proto.SizeVarint(3<<3 | proto.WireBytes)
		n += proto.SizeVarint(uint64(s))
		n += s
	case *ProcessorCoreUnion_Sorter:
		s := proto.Size(x.Sorter)
		n += proto.SizeVarint(4<<3 | proto.WireBytes)
		n += proto.SizeVarint(uint64(s))
		n += s
	case *ProcessorCoreUnion_Aggregator:
		s := proto.Size(x.Aggregator)
	...
	case *ProcessorCoreUnion_Distinct:
		...
		n += s
	case *ProcessorCoreUnion_MergeJoiner:
		s := proto.Size(x.MergeJoiner)
		n += proto.SizeVarint(8<<3 | proto.WireBytes)
		n += proto.SizeVarint(uint64(s))
		n += s
	case *ProcessorCoreUnion_HashJoiner:
		s := proto.Size(x.HashJoiner)
	...
	case *ProcessorCoreUnion_Values:
		...
		n += s
	case *ProcessorCoreUnion_Backfiller:
		s := proto.Size(x.Backfiller)
		n += proto.SizeVarint(11<<3 | proto.WireBytes)
		n += proto.SizeVarint(uint64(s))
		n += s
	case *ProcessorCoreUnion_SetOp:
		s := proto.Size(x.SetOp)
...
func (m *ProcessorCoreUnion_Noop) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Noop != nil {
		dAtA[i] = 0xa
		i++
...
func (m *ProcessorCoreUnion_TableReader) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.TableReader != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(m.TableReader.Size()))
		n8, err := m.TableReader.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n8
...
func (m *ProcessorCoreUnion_JoinReader) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.JoinReader != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(m.JoinReader.Size()))
		n9, err := m.JoinReader.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n9
...
func (m *ProcessorCoreUnion_Sorter) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Sorter != nil {
		dAtA[i] = 0x22
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(m.Sorter.Size()))
		n10, err := m.Sorter.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
func (m *ProcessorCoreUnion_Aggregator) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Aggregator != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(m.Aggregator.Size()))
		n11, err := m.Aggregator.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
...
func (m *ProcessorCoreUnion_Distinct) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Distinct != nil {
		dAtA[i] = 0x3a
		i++
...
func (m *ProcessorCoreUnion_MergeJoiner) MarshalTo(dAtA []byte) (int, error) {
	i := 0
...
func (m *ProcessorCoreUnion_HashJoiner) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.HashJoiner != nil {
		dAtA[i] = 0x4a
		i++
...
func (m *ProcessorCoreUnion_Values) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Values != nil {
		dAtA[i] = 0x52
		i++
...
func (m *ProcessorCoreUnion_Backfiller) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Backfiller != nil {
		dAtA[i] = 0x5a
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(m.Backfiller.Size()))
		n16, err := m.Backfiller.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
...
func (m *ProcessorCoreUnion_SetOp) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.SetOp != nil {
		dAtA[i] = 0x62
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(m.SetOp.Size()))
		n17, err := m.SetOp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n17
...
func (m *ProcessorCoreUnion_Noop) Size() (n int) {
	var l int
	_ = l
	if m.Noop != nil {
		l = m.Noop.Size()
...
func (m *ProcessorCoreUnion_TableReader) Size() (n int) {
	var l int
	_ = l
	if m.TableReader != nil {
...
func (m *ProcessorCoreUnion_JoinReader) Size() (n int) {
	var l int
	_ = l
	if m.JoinReader != nil {
		l = m.JoinReader.Size()
...
func (m *ProcessorCoreUnion_Sorter) Size() (n int) {
	var l int
	_ = l
	if m.Sorter != nil {
		l = m.Sorter.Size()
...
func (m *ProcessorCoreUnion_Aggregator) Size() (n int) {
	var l int
	_ = l
	if m.Aggregator != nil {
		l = m.Aggregator.Size()
...
func (m *ProcessorCoreUnion_Distinct) Size() (n int) {
	var l int
	_ = l
	if m.Distinct != nil {
		l = m.Distinct.Size()
...
func (m *ProcessorCoreUnion_MergeJoiner) Size() (n int) {
	var l int
	_ = l
	if m.MergeJoiner != nil {
...
func (m *ProcessorCoreUnion_HashJoiner) Size() (n int) {
	var l int
	_ = l
	if m.HashJoiner != nil {
		l = m.HashJoiner.Size()
...
func (m *ProcessorCoreUnion_Values) Size() (n int) {
	var l int
	_ = l
	if m.Values != nil {
		l = m.Values.Size()
...
func (m *ProcessorCoreUnion_Backfiller) Size() (n int) {
	var l int
	_ = l
	if m.Backfiller != nil {
		l = m.Backfiller.Size()
...
func (m *ProcessorCoreUnion_SetOp) Size() (n int) {
	var l int
	_ = l
	if m.SetOp != nil {
		l = m.SetOp.Size()
...
func (m *ProcessorCoreUnion) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Value = &ProcessorCoreUnion_Noop{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			m.Value = &ProcessorCoreUnion_TableReader{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.Value = &ProcessorCoreUnion_JoinReader{v}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
			...
			m.Value = &ProcessorCoreUnion_Sorter{v}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
			...
			m.Value = &ProcessorCoreUnion_Aggregator{v}
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
			...
			m.Value = &ProcessorCoreUnion_Distinct{v}
			iNdEx = postIndex
		case 8:
			if wireType != 2 {
			...
			m.Value = &ProcessorCoreUnion_MergeJoiner{v}
			iNdEx = postIndex
		case 9:
			if wireType != 2 {
			...
			m.Value = &ProcessorCoreUnion_HashJoiner{v}
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
			...
			m.Value = &ProcessorCoreUnion_Values{v}
			iNdEx = postIndex
		case 11:
			if wireType != 2 {
			...
			m.Value = &ProcessorCoreUnion_Backfiller{v}
			iNdEx = postIndex
		case 12:
			if wireType != 2 {
			...
			v := &AlgebraicSetOpSpec{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &ProcessorCoreUnion_SetOp{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipProcessors(dAtA[iNdEx:])
...
var fileDescriptorProcessors = []byte{
	...
	,
}
